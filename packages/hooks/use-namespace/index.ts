...
// BEM 命名字符拼接函数
const _bem = (
  namespace: string, // 基础命名 el
  block: string, // 容器命名 el-form
  blockSuffix: string, // 容器内的容器 el-form-item
  element: string, // 容器内的元素 el-input__inner
  modifier: string // 修改器 el-button--success
) => {
  // 默认是 Block
